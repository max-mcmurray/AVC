...
void lineMaze() {
	...
	while (1){
		...
		//For line 0
		for (int pixel = 0; pixel < scope; pixel++) {
		...
		//For line 1
		for (int pixel = width-scope; pixel < width; pixel++) {
		...
		//For line 2
		for (int pixel = height-scope; pixel < height; pixel++) {
			int pixelValue = get_pixel(pixel, columnToScan, 3);
